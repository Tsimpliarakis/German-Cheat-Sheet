...
| **die** *Terrasse* (*pl.* Terrassen) | terrace | *Auf der Terrasse sitzen wir im Sommer.* (We sit on the terrace in summer.) |
...
| **die** *Wartung* (*pl.* Wartungen) | maintenance | *Die Wartung ist notwendig.* (The maintenance is necessary.) |
